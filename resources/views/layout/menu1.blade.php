...
<head>
    ...
    <style>
        ...
        body:not(.tahan-animasi) .am-sideleft, 
        body:not(.tahan-animasi) .am-mainpanel, 
        body:not(.tahan-animasi) .am-pagetitle {
...
<body>
    <script>
        if (localStorage.getItem('sidebarState') === 'aktif') {
            document.body.classList.add('sidebar-aktif');
        }
    </script>
    <div class="am-header">
...
<script>
    $(document).ready(function() {
        $('#naviconLeft, #naviconLeftMobile').off('click').on('click', function(e) {
            e.preventDefault();
            
            // Buka tutup menu
            $('body').toggleClass('sidebar-aktif');
            
            // Simpan statusnya ke memori browser
            if ($('body').hasClass('sidebar-aktif')) {
                localStorage.setItem('sidebarState', 'aktif');
            } else {
                localStorage.setItem('sidebarState', 'sembunyi');
            }
        });
    });
</script>
